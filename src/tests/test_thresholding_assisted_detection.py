import numpy as np
from utils import threshold_segmentation, segmentation_to_cells, kmeans_segmentation
...
def test_segmentation_to_shapes_adds_to_empty_cells():
	...
	cells = {}
	segmentation_to_cells(image, cells, threshold_segmentation, 1.1, cutoff=1)
...
def test_segmentation_to_shapes_kmeans_incorporation():
	...
	cells = {10:'a'}
	segmentation_to_cells(image, cells, kmeans_segmentation, cutoff=1)
	assert len(cells) > 1
	assert cells[10] == 'a'